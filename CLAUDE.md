...
**Where a held train parks is settled, and it is not the middle.** The nose sits `HoldNoseClearanceM` (1 m) short of the far end of its block, measured from the end and applied to the nose, because the margin exists to stop a train protruding into the next zone through a defect. The brake does not put it there — it stops the train well short and the drive tyres truck it the rest of the way, up to 67 m on the mid-course brake. Changing this is changing a safety margin: read the holding section of `SIGNALLING.md` first.
